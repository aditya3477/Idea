...
API_BASE_URL = "https://techcrunch-api.onrender.com/api"

# Function to fetch data from TechCrunch API
def fetch_techcrunch_api(page=1):
    url = f"{API_BASE_URL}/articles?page={page}"
...
def schedule_scraping():
    schedule.every().day.at("10:00").do(lambda: save_data_locally(fetch_techcrunch_api(page=1)))
...
def main():
    ...
    if st.button("Fetch Latest Data from API"):
        scraped_data = fetch_techcrunch_api(page=1)
